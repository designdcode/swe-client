  ...
  [18],
  {
        ...
        Object(a.useEffect)(
          function () {
            var n,
              ...
              a,
              i = b(e, t);
            if (O.current.client === p && Object(o.a)(O.current.query, e))
              Object(o.a)(O.current.watchQueryOptions, i) ||
            ...
            if (a) {
              var l = O.current.result;
              l.data && (O.current.previousData = l.data),
                j((O.current.result = a)),
                !a.loading &&
                  t &&
                  (h.loading ||
                    (h.error
              ...
              if (!d.renderPromises) {
                var e = m.subscribe(t, function n(r) {
                  ...
                  ((u && u.loading) || !Object(o.a)(r, u.error)) &&
                    ...
                    null ===
                      (i =
                        null === (a = O.current.options) || void 0 === a
                          ? void 0
                          : a.onError) ||
                      void 0 === i ||
                      i.call(a, r));
          ...
          (f = (n = h).partial),
          (h = Object(r.f)(n, ["partial"])),
          !f ||
            !(null === t || void 0 === t ? void 0 : t.partialRefetch) ||
            h.loading ||
            (h.data && 0 !== Object.keys(h.data).length) ||
          ...
          h.errors &&
            h.errors.length &&
            (h = Object(r.a)(Object(r.a)({}, h), {
              error: h.error || new c.a({ graphQLErrors: h.errors }),
            }));
    ...
    245: function (e, t, n) {
          ...
          ? i.createElement(
              v,
              {
                className: l()(
                  ...
                  Object(r.a)(t, "".concat(n, "-item-content"), f(g)),
                  t),
                  c
                ),
                style: u,
              ...
              f(p) && i.createElement("span", { style: s }, p),
              f(g) && i.createElement("span", { style: d }, g)
            )
          : i.createElement(
              v,
              {
        ...
        return e.map(function (e, t) {
          ...
          return "string" === typeof c
            ? i.createElement(g, {
                ...
                className: h,
                style: j,
                labelStyle: Object(p.a)(Object(p.a)({}, d), O),
            ...
            : [
                i.createElement(g, {
                  ...
                  className: h,
                  style: Object(p.a)(Object(p.a)(Object(p.a)({}, d), j), O),
                  span: 1,
                  colon: r,
                  component: c[0],
                  itemPrefixCls: y,
                ...
                i.createElement(g, {
                  ...
                  className: h,
                  style: Object(p.a)(Object(p.a)(Object(p.a)({}, b), j), $),
                  span: 2 * S - 1,
                  component: c[1],
                  itemPrefixCls: y,
                  bordered: o,
      ...
      function k(e) {
          ...
          R = (function (e, t) {
            ...
            if ("object" === Object(o.a)(e))
              for (var n = 0; n < s.b.length; n++) {
                var r = s.b[n];
                if (t[r] && void 0 !== e[r]) return e[r] || O[r];
              }
            return 3;
          })(f, D);
        i.useEffect(function () {
          var e = s.a.subscribe(function (e) {
            "object" === Object(o.a)(f) && L(e);
          });
          return function () {
            s.a.unsubscribe(e);
          };
        ...
        var Q = (function (e, t) {
          ...
          M = i.useMemo(
            function () {
              return { labelStyle: x, contentStyle: B };
            },
            [x, B]
          );
    ...
    558: function (e, t, n) {
      ...
      var r,
        ...
        f = Object(d.a)(b.a)(a || (a = Object(s.a)(["\n  margin: 15px 0;\n"]))),
        g = n(139),
        m = n(104),
        v = n(132),
        y = n(11);
      t.default = function () {
        ...
        Object(l.useEffect)(
          function () {
            E(Object(v.b)(s)), A(Object(v.d)(s));
          },
          [s]
        );
        var D = Object(g.a)(m.l, { variables: { category: d } }),
          L = D.data,
          R = D.loading,
          Q = D.refetch;
        return (
          Object(l.useEffect)(
            function () {
              var e = function () {
                ...
                null !== L &&
                void 0 !== L &&
                L.getBoardByCategory.ok &&
                0 !==
                  (null === (e = L.getBoardByCategory.data) || void 0 === e
                    ? void 0
                    : e.length)
                  ? L.getBoardByCategory.data &&
                    0 !== L.getBoardByCategory.data.length &&
                    (L.getBoardByCategory.data[0].files &&
                      $(L.getBoardByCategory.data[0].files),
                    L.getBoardByCategory.data[0].images &&
                      w(L.getBoardByCategory.data[0].images))
                  : ($([]), w([]));
              };
              return (
                e(),
                            ...
                            onClick: function () {
                              return n.push(
                                "/admin/"
                                  ...
                                  .concat(
                                    L.getBoardByCategory.data &&
                                      L.getBoardByCategory.data[0].id
                                  )
                              );
                            },
                            children: "\uc218\uc815\ud558\uae30",
                        ...
                        Object(y.jsx)(i.b.Item, {
                          ...
                          children:
                            0 !==
                              (null === L ||
                              void 0 === L ||
                              null === (t = L.getBoardByCategory.data) ||
                              void 0 === t
                                ? void 0
                                : t.length) &&
                            null !== L &&
                            ...
                            L.getBoardByCategory.ok
                              ? Object(y.jsx)("a", {
                                  href: "".concat(
                                    L.getBoardByCategory.data &&
                                      L.getBoardByCategory.data[0].link
                                  ),
                                  target: "_blank",
                                  rel: "noreferrer",
                                  children:
...
//# sourceMappingURL=18.628c159e.chunk.js.map
