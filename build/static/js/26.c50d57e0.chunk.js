    ...
    535: function (n, t, e) {
      ...
      t.default = function () {
        var n,
          ...
          v = m[0],
          U = m[1],
          Y = localStorage.getItem("stno"),
          K = Object(g.useState)(!1),
          P = Object(x.a)(K, 2),
          Q = P[0],
          R = P[1],
          V = Object(O.a)(y.b, { variables: { id: parseInt(b, 10) } }),
          X = V.data,
          Z = V.loading;
        return (
          Object(g.useEffect)(
            function () {
              U(Object(w.a)(h)), R(Object(L.e)(h));
            },
            [h]
          ),
          Object(g.useEffect)(
            function () {
              ...
              null !== X &&
                void 0 !== X &&
                null !== (n = X.getBoardById.data) &&
                void 0 !== n &&
                n.private &&
                X.getBoardById.data.writer !== Y &&
                (S.b.info("\ube44\ubc00\uae00 \uc785\ub2c8\ub2e4"),
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Object(M.jsx)("div", {
                                    children:
                                      null !== X &&
                                      void 0 !== X &&
                                      null !== (e = X.getBoardById.data) &&
                                      void 0 !== e &&
                                      e.writer
                                        ? null === X || void 0 === X
                                          ? void 0
                                          : X.getBoardById.data.writer
                                        : "\uad00\ub9ac\uc790",
                                  }),
                                ],
                              }),
                          ...
                          Object(M.jsxs)(C, {
                            children: [
                              null !== X &&
                              void 0 !== X &&
                              null !== (i = X.getBoardById.data) &&
                              void 0 !== i &&
                              i.images &&
                              X.getBoardById.data.images[0]
                                ? Object(M.jsx)("img", {
                                    src: X.getBoardById.data.images[0].url,
                              ...
                              (null === X ||
                              void 0 === X ||
                              null === (a = X.getBoardById.data) ||
                              void 0 === a
                                ? void 0
                                : a.showAttach) &&
                                (null === X ||
                                void 0 === X ||
                                null === (o = X.getBoardById.data) ||
                                void 0 === o
                                  ? void 0
                                  : o.files) &&
                                X.getBoardById.data.files.length > 0 &&
                                Object(M.jsx)("div", {
                                  className: "content-body-attachment",
                                  children:
                                    null === X ||
                                    void 0 === X ||
                                    null === (d = X.getBoardById.data) ||
                                    void 0 === d
                                      ? void 0
                              ...
                              Object(M.jsx)("div", {
                                ...
                                dangerouslySetInnerHTML: {
                                  __html:
                                    (X &&
                                      X.getBoardById.data &&
                                      X.getBoardById.data.replies &&
                                      X.getBoardById.data.replies[0] &&
                                      (null ===
                                        (r = X.getBoardById.data.replies[0]) ||
                                      void 0 === r
                                        ? void 0
                                        : r.content)) ||
                                    "",
...
//# sourceMappingURL=26.c50d57e0.chunk.js.map
